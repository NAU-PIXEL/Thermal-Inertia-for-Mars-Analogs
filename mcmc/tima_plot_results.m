...
if size(RESULTS,2) == 6
    formod = @(FitVar) tima_heat_transfer(FitVar(1),FitVar(2),FitVar(3),...
        ...
        TData.pressure_air_Pa,TData.temps_to_fit,'albedo',TData.timed_albedo,'material',MData.material);%,'e_fxn',MData.e_fxn);
...
elseif size(RESULTS,2) == 7
     formod = @(FitVar) tima_heat_transfer(FitVar(1),FitVar(2),FitVar(3),...
        ...
        TData.r_short_lower,TData.r_long_upper,TData.windspeed_horiz_ms,MData.T_deep,MData.T_start,MData.layer_size,...
        TData.VWC_column,TData.evap_depth,TData.humidity,MData.emissivity,...
        TData.pressure_air_Pa,TData.temps_to_fit,'albedo',TData.timed_albedo,'material',MData.material,'depth_transition',FitVar(7),'material_lower',MData.material_lower);%,'e_fxn',MData.e_fxn);
