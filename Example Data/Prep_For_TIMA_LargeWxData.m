...
for i = 1:length(stability_array) %Loop to optimize layer thickness (i.e. highest resolution w/o becomming unstable or costing too much computation time)
    ...
    formod = @(FitVar) tima_full_model(FitVar(1),FitVar(2),FitVar(3),...
        ...
        Pressure_air_Pa,Interpolated_Temp,NDAYS,'albedo',Albedo,'material',material,...
        ...
        'k_dry_std_lower',FitVar(8));

    % %DEBUG: If the initialization looks good, but the MCMC run returns: 'Starting
