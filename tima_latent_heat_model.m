function [q_latent,soil_RH] = tima_latent_heat_model(CE,theta_E,pressure_air_Pa,windspeed_horiz,RH,air_temp_K,T_ground_K,soil_VWC)
%***************
% TIMA_LATENT_HEAT_MODEL
...
%   theta_E: latent heat soil moisture inflection point (% by Vol)
...
%   soil_VWC: soil volumetric water content at depth of interest (% by Vol)
